<!--{include file="application.views.install.header"}-->

<div class="container" style="width:600px; margin-top: 150px;" >
<form class="form-horizontal"  method="post" action="<!--{$baseUrl}-->/install.php/install/install" >
...
<!--{if ($success|default:false)}-->
    	<p class="alert alert-success text-center" role="alert">База данных успешно восстановлена из дампа.</br>
            <a class="alert-link" href="<!--{$baseUrl}-->/index.php">Перейти на главную страницу сайта.</a></p>
<!--{/if}-->

</div>

<!--{include file="install/footer.tpl"}-->
