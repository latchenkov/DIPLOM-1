...
(11,	1430641902000,	'Ищу объектив',	5001,	'Елена',	'private',	'lena@ya.ru',	0,	'89101234567',	'Барабинск',	'Фототехника',	'Нужен объектив 24-70 для Canon'),
(12,	1430641916000,	'Продаются котята',	25000,	'Вячеслав',	'private',	'slava34@mail.ru',	1,	'8-499-123-45',	'Мошково',	'Кошки',	'Продаются котята мейн-куна.'),
(13,	1430641926000,	'Возьмем склад в аренду',	1200,	'ООО \"Взлет\"',	'corporate',	'info@ooovzlet.ru',	0,	'8-928-765-43',	'Бердск',	'Коммерческая недвижимость',	'Нужен в аренду теплый склад от 1000 кв. м.'),
...
(16,	1430641949000,	'Нужны картографисты',	60000,	'ЗАО \"Атлас\"',	'corporate',	'atlas@ya.ru',	0,	'963-48-12',	'Краснообск',	'Вакансии (поиск сотрудников)',	'Организация приглашает на работу картографистов. Оплата высокая.'),
